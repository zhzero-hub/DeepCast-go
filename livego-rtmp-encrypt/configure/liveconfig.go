...
var (
	...
	//
	// go build -ldflags "-X 'DeepCast/livego-rtmp-encrypt/configure.BypassInit=true'" -o livego main.go
	BypassInit string = ""
)
...
func initDefault() {
	...
	// File
	Config.SetConfigFile("./livego-rtmp-encrypt/" + Config.GetString("config_file"))
